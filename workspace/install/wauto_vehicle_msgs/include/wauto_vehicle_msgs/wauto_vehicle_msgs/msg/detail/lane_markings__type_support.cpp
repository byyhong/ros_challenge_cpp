...
{
  new (message_memory) wauto_vehicle_msgs::msg::LaneMarkings(_init);
}

void LaneMarkings_fini_function(void * message_memory)
{
  auto typed_message = static_cast<wauto_vehicle_msgs::msg::LaneMarkings *>(message_memory);
  typed_message->~LaneMarkings();
}

static const ::rosidl_typesupport_introspection_cpp::MessageMember LaneMarkings_message_member_array[3] = {
  {
    "rolling_count",  // name
    ...
    offsetof(wauto_vehicle_msgs::msg::LaneMarkings, rolling_count),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(wauto_vehicle_msgs::msg::LaneMarkings, currentlanemarkingcount),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(wauto_vehicle_msgs::msg::LaneMarkings, observation_time_of_hour),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers LaneMarkings_message_members = {
  ...
  3,  // number of fields
  sizeof(wauto_vehicle_msgs::msg::LaneMarkings),
...
{
  return &::wauto_vehicle_msgs::msg::rosidl_typesupport_introspection_cpp::LaneMarkings_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, wauto_vehicle_msgs, msg, LaneMarkings)() {
  return &::wauto_vehicle_msgs::msg::rosidl_typesupport_introspection_cpp::LaneMarkings_message_type_support_handle;
}
