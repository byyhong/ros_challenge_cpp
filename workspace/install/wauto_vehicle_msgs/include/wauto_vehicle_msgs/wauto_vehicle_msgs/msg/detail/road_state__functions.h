...
#ifndef WAUTO_VEHICLE_MSGS__MSG__DETAIL__ROAD_STATE__FUNCTIONS_H_
#define WAUTO_VEHICLE_MSGS__MSG__DETAIL__ROAD_STATE__FUNCTIONS_H_
 ...
 * calls
 * wauto_vehicle_msgs__msg__RoadState__init().
...
/**
 * It calls
 * wauto_vehicle_msgs__msg__RoadState__fini()
 ...
 * wauto_vehicle_msgs__msg__RoadState__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * wauto_vehicle_msgs__msg__RoadState__Sequence__fini()
 * on the array,
...
#endif  // WAUTO_VEHICLE_MSGS__MSG__DETAIL__ROAD_STATE__FUNCTIONS_H_
