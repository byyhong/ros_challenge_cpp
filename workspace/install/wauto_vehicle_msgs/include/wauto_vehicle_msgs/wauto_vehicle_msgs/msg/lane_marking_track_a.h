...
#ifndef WAUTO_VEHICLE_MSGS__MSG__LANE_MARKING_TRACK_A_H_
#define WAUTO_VEHICLE_MSGS__MSG__LANE_MARKING_TRACK_A_H_
...
#endif  // WAUTO_VEHICLE_MSGS__MSG__LANE_MARKING_TRACK_A_H_
