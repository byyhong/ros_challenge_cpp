...
class Metaclass_Objects(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'wauto_vehicle_msgs.msg.Objects')
            logger.debug(
    ...
    def __prepare__(cls, name, bases, **kwargs):
        ...
        return {
            ...
            'CURRENT_OBJECT_COUNT__DEFAULT': 0,
    ...
    def NAME(self):
        ...
        return Metaclass_Objects.__constants['NAME']
    ...
    @property
    def CURRENT_OBJECT_COUNT__DEFAULT(cls):
        """Return default value for message field 'current_object_count'."""
        return 0
...
class Objects(metaclass=Metaclass_Objects):
    ...
    def __init__(self, **kwargs):
        ...
        self.rolling_count = kwargs.get(
            'rolling_count', Objects.ROLLING_COUNT__DEFAULT)
        self.current_object_count = kwargs.get(
            'current_object_count', Objects.CURRENT_OBJECT_COUNT__DEFAULT)
        self.observation_time_of_hour = kwargs.get(
            'observation_time_of_hour', Objects.OBSERVATION_TIME_OF_HOUR__DEFAULT)
    ...
    def __eq__(self, other):
        ...
        if self.rolling_count != other.rolling_count:
            return False
        if self.current_object_count != other.current_object_count:
            return False
    ...
    def current_object_count(self):
        """Message field 'current_object_count'."""
        return self._current_object_count

    @current_object_count.setter
    def current_object_count(self, value):
        if __debug__:
            assert \
                isinstance(value, int), \
                "The 'current_object_count' field must be of type 'int'"
            assert value >= 0 and value < 256, \
                "The 'current_object_count' field must be an unsigned integer in [0, 255]"
        self._current_object_count = value
