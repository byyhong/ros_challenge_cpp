...
class Metaclass_AVState(type):
    """Metaclass of message 'AVState'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'wauto_vehicle_msgs.msg.AVState')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__av_state
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__av_state
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__av_state
            cls._TYPE_SUPPORT = module.type_support_msg__msg__av_state
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__av_state
    ...
    def NAME(self):
        ...
        return Metaclass_AVState.__constants['NAME']
...
class AVState(metaclass=Metaclass_AVState):
    """
    Message class 'AVState'.
    ...
    def __init__(self, **kwargs):
        ...
        self.unused_msg_placeholder = kwargs.get(
            'unused_msg_placeholder', AVState.UNUSED_MSG_PLACEHOLDER__DEFAULT)
