...
bool wauto_perception_msgs__msg__cluster__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("wauto_perception_msgs.msg._cluster.Cluster", full_classname_dest, 42) == 0);
  }
  wauto_perception_msgs__msg__Cluster * ros_message = _ros_message;
  {  // header
...
PyObject * wauto_perception_msgs__msg__cluster__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("wauto_perception_msgs.msg._cluster");
