...
: ${AMENT_CURRENT_PREFIX:="/home/atk-sandbox/atk-sandbox/workspace/install/common_pkgs"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/common_pkgs/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/common_pkgs/environment/path.sh"
