...
bool wauto_control_msgs__msg__car_tbs__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("wauto_control_msgs.msg._car_tbs.CarTBS", full_classname_dest, 38) == 0);
  }
  wauto_control_msgs__msg__CarTBS * ros_message = _ros_message;
  {  // t
...
{
  /* NOTE(esteve): Call constructor of CarTBS */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("wauto_control_msgs.msg._car_tbs");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "CarTBS");
