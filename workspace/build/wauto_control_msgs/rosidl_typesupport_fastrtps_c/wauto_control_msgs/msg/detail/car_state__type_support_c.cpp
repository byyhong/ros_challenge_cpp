...
#include "wauto_control_msgs/msg/detail/car_state__rosidl_typesupport_fastrtps_c.h"
...
using _CarState__ros_msg_type = wauto_control_msgs__msg__CarState;
...
static uint32_t _CarState__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_wauto_control_msgs__msg__CarState(
...
static size_t _CarState__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_wauto_control_msgs__msg__CarState(
