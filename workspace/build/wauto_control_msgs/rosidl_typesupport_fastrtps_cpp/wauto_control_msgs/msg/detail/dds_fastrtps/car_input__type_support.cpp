...
#include "wauto_control_msgs/msg/detail/car_input__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const wauto_control_msgs::msg::CarInput & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  wauto_control_msgs::msg::CarInput & ros_message)
{
  // Member: v_dot
  cdr >> ros_message.v_dot;
...
{
  auto typed_message =
    static_cast<const wauto_control_msgs::msg::CarInput *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<wauto_control_msgs::msg::CarInput *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _CarInput__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const wauto_control_msgs::msg::CarInput *>(
...
static size_t _CarInput__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_CarInput(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _CarInput__callbacks = {
...
static rosidl_message_type_support_t _CarInput__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_CarInput__callbacks,
...
{
  return &wauto_control_msgs::msg::typesupport_fastrtps_cpp::_CarInput__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, wauto_control_msgs, msg, CarInput)() {
  return &wauto_control_msgs::msg::typesupport_fastrtps_cpp::_CarInput__handle;
}
