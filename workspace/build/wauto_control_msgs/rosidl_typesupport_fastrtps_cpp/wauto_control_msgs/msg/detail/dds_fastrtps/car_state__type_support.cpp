...
#include "wauto_control_msgs/msg/detail/car_state__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
  auto typed_message =
    static_cast<const wauto_control_msgs::msg::CarState *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<wauto_control_msgs::msg::CarState *>(
    untyped_ros_message);
...
{
  return &wauto_control_msgs::msg::typesupport_fastrtps_cpp::_CarState__handle;
}
