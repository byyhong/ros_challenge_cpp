...
#include "wauto_control_msgs/msg/detail/lane_marking__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const wauto_control_msgs::msg::LaneMarking & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  {
    cdr << ros_message.coordinates_x;
  }
  // Member: coordinates_y
  {
    cdr << ros_message.coordinates_y;
  }
  return true;
}
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  wauto_control_msgs::msg::LaneMarking & ros_message)
{
  // Member: boundary_type
  cdr >> ros_message.boundary_type;
  ...
  size_t current_alignment)
{
  ...
  // Member: coordinates_x
  {
    ...
    size_t item_size = sizeof(ros_message.coordinates_x[0]);
  ...
  {
    size_t array_size = 20;
    size_t item_size = sizeof(ros_message.coordinates_y[0]);
    current_alignment += array_size * item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
...
{
  auto typed_message =
    static_cast<const wauto_control_msgs::msg::LaneMarking *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<wauto_control_msgs::msg::LaneMarking *>(
    untyped_ros_message);
...
{
  return &wauto_control_msgs::msg::typesupport_fastrtps_cpp::_LaneMarking__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, wauto_control_msgs, msg, LaneMarking)() {
  return &wauto_control_msgs::msg::typesupport_fastrtps_cpp::_LaneMarking__handle;
}
