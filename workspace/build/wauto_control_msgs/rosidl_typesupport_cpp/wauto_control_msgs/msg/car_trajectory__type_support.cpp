...
static const _CarTrajectory_type_support_symbol_names_t _CarTrajectory_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, wauto_control_msgs, msg, CarTrajectory)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, wauto_control_msgs, msg, CarTrajectory)),
  }
};
...
{
  return &::wauto_control_msgs::msg::rosidl_typesupport_cpp::CarTrajectory_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, wauto_control_msgs, msg, CarTrajectory)() {
  return get_message_type_support_handle<wauto_control_msgs::msg::CarTrajectory>();
}
