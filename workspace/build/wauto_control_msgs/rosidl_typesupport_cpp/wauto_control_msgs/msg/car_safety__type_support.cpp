...
static const _CarSafety_type_support_symbol_names_t _CarSafety_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, wauto_control_msgs, msg, CarSafety)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, wauto_control_msgs, msg, CarSafety)),
  }
};
...
{
  return &::wauto_control_msgs::msg::rosidl_typesupport_cpp::CarSafety_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, wauto_control_msgs, msg, CarSafety)() {
  return get_message_type_support_handle<wauto_control_msgs::msg::CarSafety>();
}
