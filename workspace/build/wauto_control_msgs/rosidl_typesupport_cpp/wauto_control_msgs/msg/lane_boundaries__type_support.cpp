...
static const _LaneBoundaries_type_support_symbol_names_t _LaneBoundaries_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, wauto_control_msgs, msg, LaneBoundaries)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, wauto_control_msgs, msg, LaneBoundaries)),
  }
};
...
{
  return &::wauto_control_msgs::msg::rosidl_typesupport_cpp::LaneBoundaries_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, wauto_control_msgs, msg, LaneBoundaries)() {
  return get_message_type_support_handle<wauto_control_msgs::msg::LaneBoundaries>();
}
