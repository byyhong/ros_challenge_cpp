...
#include "wauto_perception_msgs/msg/detail/cluster__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
  auto typed_message =
    static_cast<const wauto_perception_msgs::msg::Cluster *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<wauto_perception_msgs::msg::Cluster *>(
    untyped_ros_message);
...
{
  return &wauto_perception_msgs::msg::typesupport_fastrtps_cpp::_Cluster__handle;
}
