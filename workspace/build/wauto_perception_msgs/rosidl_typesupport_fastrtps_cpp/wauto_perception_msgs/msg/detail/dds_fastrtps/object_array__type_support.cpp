...
#include "wauto_perception_msgs/msg/detail/object_array__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const wauto_perception_msgs::msg::Object &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
  wauto_perception_msgs::msg::Object &);
size_t get_serialized_size(
  const wauto_perception_msgs::msg::Object &,
  size_t current_alignment);
size_t
...
cdr_serialize(
  const wauto_perception_msgs::msg::ObjectArray & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  wauto_perception_msgs::msg::ObjectArray & ros_message)
{
  // Member: header
  ...
  size_t current_alignment)
{
  ...
  // Member: objects
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      current_alignment +=
        wauto_perception_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_Object(
        inner_full_bounded, inner_is_plain, current_alignment);
      full_bounded &= inner_full_bounded;
      is_plain &= inner_is_plain;
    }
...
{
  auto typed_message =
    static_cast<const wauto_perception_msgs::msg::ObjectArray *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<wauto_perception_msgs::msg::ObjectArray *>(
    untyped_ros_message);
...
{
  return &wauto_perception_msgs::msg::typesupport_fastrtps_cpp::_ObjectArray__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, wauto_perception_msgs, msg, ObjectArray)() {
  return &wauto_perception_msgs::msg::typesupport_fastrtps_cpp::_ObjectArray__handle;
}
