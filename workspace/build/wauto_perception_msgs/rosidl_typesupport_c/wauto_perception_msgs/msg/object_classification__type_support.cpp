...
static const _ObjectClassification_type_support_symbol_names_t _ObjectClassification_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, wauto_perception_msgs, msg, ObjectClassification)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, wauto_perception_msgs, msg, ObjectClassification)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, wauto_perception_msgs, msg, ObjectClassification)() {
  return &::wauto_perception_msgs::msg::rosidl_typesupport_c::ObjectClassification_message_type_support_handle;
}
