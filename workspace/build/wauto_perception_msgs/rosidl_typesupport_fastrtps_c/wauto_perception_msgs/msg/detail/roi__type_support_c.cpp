...
#include "wauto_perception_msgs/msg/detail/roi__rosidl_typesupport_fastrtps_c.h"
...
#include "geometry_msgs/msg/detail/point__functions.h"  // bottom_left, top_right
#include "wauto_perception_msgs/msg/detail/object_classification__functions.h"  // classification
...
size_t get_serialized_size_wauto_perception_msgs__msg__ObjectClassification(
  const void * untyped_ros_message,
  size_t current_alignment);

size_t max_serialized_size_wauto_perception_msgs__msg__ObjectClassification(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment);

const rosidl_message_type_support_t *
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, wauto_perception_msgs, msg, ObjectClassification)();


using _Roi__ros_msg_type = wauto_perception_msgs__msg__Roi;
  ...
  // Field name: classification
  {
    const message_type_support_callbacks_t * callbacks =
      ...
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, wauto_perception_msgs, msg, ObjectClassification
      )()->data);
  ...
  size_t current_alignment)
{
  ...
  current_alignment += get_serialized_size_wauto_perception_msgs__msg__ObjectClassification(
...
static uint32_t _Roi__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_wauto_perception_msgs__msg__Roi(
  ...
  size_t current_alignment)
{
  ...
  // member: classification
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      current_alignment +=
        max_serialized_size_wauto_perception_msgs__msg__ObjectClassification(
...
static size_t _Roi__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_wauto_perception_msgs__msg__Roi(
