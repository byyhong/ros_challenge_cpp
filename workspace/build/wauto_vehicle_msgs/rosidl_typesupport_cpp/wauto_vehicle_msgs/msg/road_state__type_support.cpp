...
static const _RoadState_type_support_symbol_names_t _RoadState_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, wauto_vehicle_msgs, msg, RoadState)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, wauto_vehicle_msgs, msg, RoadState)),
  }
};
...
{
  return &::wauto_vehicle_msgs::msg::rosidl_typesupport_cpp::RoadState_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, wauto_vehicle_msgs, msg, RoadState)() {
  return get_message_type_support_handle<wauto_vehicle_msgs::msg::RoadState>();
}
