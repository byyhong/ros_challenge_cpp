...
static const _LaneMarkingTrackA_type_support_symbol_names_t _LaneMarkingTrackA_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, wauto_vehicle_msgs, msg, LaneMarkingTrackA)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, wauto_vehicle_msgs, msg, LaneMarkingTrackA)),
  }
};
...
{
  return &::wauto_vehicle_msgs::msg::rosidl_typesupport_cpp::LaneMarkingTrackA_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, wauto_vehicle_msgs, msg, LaneMarkingTrackA)() {
  return get_message_type_support_handle<wauto_vehicle_msgs::msg::LaneMarkingTrackA>();
}
