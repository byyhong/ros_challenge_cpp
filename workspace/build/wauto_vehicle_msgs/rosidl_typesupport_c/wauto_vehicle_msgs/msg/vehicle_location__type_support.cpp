...
static const _VehicleLocation_type_support_symbol_names_t _VehicleLocation_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, wauto_vehicle_msgs, msg, VehicleLocation)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, wauto_vehicle_msgs, msg, VehicleLocation)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, wauto_vehicle_msgs, msg, VehicleLocation)() {
  return &::wauto_vehicle_msgs::msg::rosidl_typesupport_c::VehicleLocation_message_type_support_handle;
}
