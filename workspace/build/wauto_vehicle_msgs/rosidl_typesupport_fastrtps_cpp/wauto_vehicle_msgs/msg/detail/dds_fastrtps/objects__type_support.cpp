...
#include "wauto_vehicle_msgs/msg/detail/objects__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const wauto_vehicle_msgs::msg::Objects & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  wauto_vehicle_msgs::msg::Objects & ros_message)
{
  // Member: rolling_count
  cdr >> ros_message.rolling_count;
...
{
  auto typed_message =
    static_cast<const wauto_vehicle_msgs::msg::Objects *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<wauto_vehicle_msgs::msg::Objects *>(
    untyped_ros_message);
...
{
  return &wauto_vehicle_msgs::msg::typesupport_fastrtps_cpp::_Objects__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, wauto_vehicle_msgs, msg, Objects)() {
  return &wauto_vehicle_msgs::msg::typesupport_fastrtps_cpp::_Objects__handle;
}
