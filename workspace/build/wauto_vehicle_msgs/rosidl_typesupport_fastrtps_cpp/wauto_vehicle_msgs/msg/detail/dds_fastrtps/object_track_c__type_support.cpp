...
#include "wauto_vehicle_msgs/msg/detail/object_track_c__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const wauto_vehicle_msgs::msg::ObjectTrackC & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  wauto_vehicle_msgs::msg::ObjectTrackC & ros_message)
{
  // Member: rolling_count
  cdr >> ros_message.rolling_count;
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_wauto_vehicle_msgs
max_serialized_size_ObjectTrackC(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
{
  auto typed_message =
    static_cast<const wauto_vehicle_msgs::msg::ObjectTrackC *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<wauto_vehicle_msgs::msg::ObjectTrackC *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _ObjectTrackC__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const wauto_vehicle_msgs::msg::ObjectTrackC *>(
...
static size_t _ObjectTrackC__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_ObjectTrackC(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _ObjectTrackC__callbacks = {
...
static rosidl_message_type_support_t _ObjectTrackC__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_ObjectTrackC__callbacks,
...
{
  return &wauto_vehicle_msgs::msg::typesupport_fastrtps_cpp::_ObjectTrackC__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, wauto_vehicle_msgs, msg, ObjectTrackC)() {
  return &wauto_vehicle_msgs::msg::typesupport_fastrtps_cpp::_ObjectTrackC__handle;
}
