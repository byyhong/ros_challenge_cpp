...
#include "wauto_vehicle_msgs/msg/detail/traffic_signs__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const wauto_vehicle_msgs::msg::TrafficSigns & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  wauto_vehicle_msgs::msg::TrafficSigns & ros_message)
{
  // Member: rolling_count
  cdr >> ros_message.rolling_count;
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_wauto_vehicle_msgs
max_serialized_size_TrafficSigns(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
{
  auto typed_message =
    static_cast<const wauto_vehicle_msgs::msg::TrafficSigns *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<wauto_vehicle_msgs::msg::TrafficSigns *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _TrafficSigns__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const wauto_vehicle_msgs::msg::TrafficSigns *>(
...
static size_t _TrafficSigns__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_TrafficSigns(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _TrafficSigns__callbacks = {
...
static rosidl_message_type_support_t _TrafficSigns__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_TrafficSigns__callbacks,
...
{
  return &wauto_vehicle_msgs::msg::typesupport_fastrtps_cpp::_TrafficSigns__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, wauto_vehicle_msgs, msg, TrafficSigns)() {
  return &wauto_vehicle_msgs::msg::typesupport_fastrtps_cpp::_TrafficSigns__handle;
}
