...
#include "wauto_vehicle_msgs/msg/detail/object_track_a__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const wauto_vehicle_msgs::msg::ObjectTrackA & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  wauto_vehicle_msgs::msg::ObjectTrackA & ros_message)
{
  // Member: rolling_count
  cdr >> ros_message.rolling_count;
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_wauto_vehicle_msgs
max_serialized_size_ObjectTrackA(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
{
  auto typed_message =
    static_cast<const wauto_vehicle_msgs::msg::ObjectTrackA *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<wauto_vehicle_msgs::msg::ObjectTrackA *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _ObjectTrackA__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const wauto_vehicle_msgs::msg::ObjectTrackA *>(
...
static size_t _ObjectTrackA__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_ObjectTrackA(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _ObjectTrackA__callbacks = {
...
static rosidl_message_type_support_t _ObjectTrackA__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_ObjectTrackA__callbacks,
...
{
  return &wauto_vehicle_msgs::msg::typesupport_fastrtps_cpp::_ObjectTrackA__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, wauto_vehicle_msgs, msg, ObjectTrackA)() {
  return &wauto_vehicle_msgs::msg::typesupport_fastrtps_cpp::_ObjectTrackA__handle;
}
