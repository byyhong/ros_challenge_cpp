...
#include "wauto_vehicle_msgs/msg/detail/traffic_sign_track_a__rosidl_typesupport_fastrtps_c.h"
...
using _TrafficSignTrackA__ros_msg_type = wauto_vehicle_msgs__msg__TrafficSignTrackA;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _TrafficSignTrackA__ros_msg_type * ros_message = static_cast<const _TrafficSignTrackA__ros_msg_type *>(untyped_ros_message);
  // Field name: rolling_count
  {
    cdr << ros_message->rolling_count;
  }

  // Field name: signobjectid
  {
  ...
  void * untyped_ros_message)
{
  ...
  _TrafficSignTrackA__ros_msg_type * ros_message = static_cast<_TrafficSignTrackA__ros_msg_type *>(untyped_ros_message);
  // Field name: rolling_count
  {
    cdr >> ros_message->rolling_count;
  }
...
size_t get_serialized_size_wauto_vehicle_msgs__msg__TrafficSignTrackA(
  const void * untyped_ros_message,
...
static uint32_t _TrafficSignTrackA__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_wauto_vehicle_msgs__msg__TrafficSignTrackA(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_wauto_vehicle_msgs
size_t max_serialized_size_wauto_vehicle_msgs__msg__TrafficSignTrackA(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
static size_t _TrafficSignTrackA__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_wauto_vehicle_msgs__msg__TrafficSignTrackA(
...
static message_type_support_callbacks_t __callbacks_TrafficSignTrackA = {
...
static rosidl_message_type_support_t _TrafficSignTrackA__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_TrafficSignTrackA,
  get_message_typesupport_handle_function,
};

const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, wauto_vehicle_msgs, msg, TrafficSignTrackA)() {
  return &_TrafficSignTrackA__type_support;
}
