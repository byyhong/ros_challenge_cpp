...
#include "wauto_vehicle_msgs/msg/detail/objects__rosidl_typesupport_fastrtps_c.h"
...
using _Objects__ros_msg_type = wauto_vehicle_msgs__msg__Objects;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: current_object_count
  {
    cdr << ros_message->current_object_count;
  }
...
size_t get_serialized_size_wauto_vehicle_msgs__msg__Objects(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  ...
  // field.name current_object_count
  {
    size_t item_size = sizeof(ros_message->current_object_count);
    current_alignment += item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  // field.name observation_time_of_hour
...
static uint32_t _Objects__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_wauto_vehicle_msgs__msg__Objects(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_wauto_vehicle_msgs
size_t max_serialized_size_wauto_vehicle_msgs__msg__Objects(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
static size_t _Objects__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_wauto_vehicle_msgs__msg__Objects(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, wauto_vehicle_msgs, msg, Objects)() {
