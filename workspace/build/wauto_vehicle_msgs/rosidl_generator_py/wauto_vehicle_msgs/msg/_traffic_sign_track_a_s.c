...
bool wauto_vehicle_msgs__msg__traffic_sign_track_a__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("wauto_vehicle_msgs.msg._traffic_sign_track_a.TrafficSignTrackA", full_classname_dest, 62) == 0);
  }
  wauto_vehicle_msgs__msg__TrafficSignTrackA * ros_message = _ros_message;
  {  // rolling_count
  ...
  {  // signobjectid
    PyObject * field = PyObject_GetAttrString(_pymsg, "signobjectid");
    if (!field) {
      return false;
    }
    assert(PyLong_Check(field));
    ros_message->signobjectid = (uint8_t)PyLong_AsUnsignedLong(field);
    Py_DECREF(field);
  }
  {  // confidence
  ...
  {  // sign_value
    PyObject * field = PyObject_GetAttrString(_pymsg, "sign_value");
    if (!field) {
      return false;
    }
    assert(PyLong_Check(field));
    ros_message->sign_value = (uint8_t)PyLong_AsUnsignedLong(field);
    Py_DECREF(field);
  }
...
{
  /* NOTE(esteve): Call constructor of TrafficSignTrackA */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("wauto_vehicle_msgs.msg._traffic_sign_track_a");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "TrafficSignTrackA");
  ...
  {  // signobjectid
    PyObject * field = NULL;
    field = PyLong_FromUnsignedLong(ros_message->signobjectid);
    {
      int rc = PyObject_SetAttrString(_pymessage, "signobjectid", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
  ...
  {  // sign_value
    PyObject * field = NULL;
    field = PyLong_FromUnsignedLong(ros_message->sign_value);
    {
      int rc = PyObject_SetAttrString(_pymessage, "sign_value", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
